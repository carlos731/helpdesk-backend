...
import com.software.helpdesk.repositories.TecnicoRepository;
...
public class DBService {
	...
	public void instanciaDB() {
		Tecnico tec1 = new Tecnico(null, "Carlos Henrique", "63653230268", "carlos@mail.com", "123");
		...
		Cliente cli1 = new Cliente(null, "Albert Einstein", "111.661.890-74", "einstein@gmail.com", "123");
		Cliente cli2 = new Cliente(null, "Marie Curie", "322.429.140-06", "curiel@gmail.com", "123");
		Cliente cli3 = new Cliente(null, "Charles Darwin", "792.043.830-62", "darwin@gmail.com", "123");
		Cliente cli4 = new Cliente(null, "Stephen Hawking", "177.409.680-30", "hawking@gmail.com", "123");
		Cliente cli5 = new Cliente(null, "Max Planck", "081.399.300-83", "planck@gmail.com", "123");
